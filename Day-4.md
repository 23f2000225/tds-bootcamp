...
--- Before Day-4 ---
I already knew that websites communicate using requests and responses, but I did not have a clear understanding of APIs and HTTP methods.
--- 
...
I learned about HTTP methods, status codes, browser developer tools, cURL commands, and API testing. 
I also learned how to create and test a simple FastAPI application.

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback ...
The practical API exercises were valuable. More real-world API examples would make the concepts easier to connect to everyday applications.
