...
--- Before Day-5 ---
I already knew that Git is used for version control and that GitHub hosts repositories online, but I had limited experience using Git commands.
--- 
...
I learned the Git workflow, including staging, committing, pushing changes, managing repositories, using .gitignore files, creating tags, and understanding branches and remotes.

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback ...
The Git workflow explanations were helpful. Additional examples involving collaboration and pull requests would be useful for beginners.
